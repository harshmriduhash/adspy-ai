      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4 animate-fade-in">
            ...
            <span className="text-sm font-medium">AI-Powered Ad Intelligence</span>
          </div>
          ...
          <p className="text-2xl text-muted-foreground max-w-3xl mx-auto animate-fade-in leading-relaxed" style={{ animationDelay: '0.1s' }}>
            Unlock the secrets behind winning SaaS ads. Analyze top campaigns, compare strategies, and generate high-converting variations—all powered by AI.
          </p>
          
          <div className="flex gap-4 justify-center animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <Link to="/dashboard">
              <Button size="lg" className="text-lg gap-2 shadow-[0_0_30px_rgba(147,51,234,0.4)] hover:shadow-[0_0_50px_rgba(147,51,234,0.6)] transition-all">
                Start Analyzing Now
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-20 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <div className="p-8 rounded-xl border border-border/50 bg-card/50 backdrop-blur-xl card-hover group">
              ...
              <p className="text-muted-foreground">Browse ads from leading SaaS brands like Notion, Slack, Figma, and 15+ more companies</p>
            </div>
            ...
            <div className="p-8 rounded-xl border border-border/50 bg-card/50 backdrop-blur-xl card-hover group">
              ...
              <p className="text-muted-foreground">Deep insights into messaging, emotional hooks, and conversion strategies with advanced AI</p>
            </div>
            ...
            <div className="p-8 rounded-xl border border-border/50 bg-card/50 backdrop-blur-xl card-hover group">
              ...
              <p className="text-muted-foreground">Compare multiple ads side-by-side and generate winning variations instantly</p>
            </div>
          </div>
        </div>
      </div>
